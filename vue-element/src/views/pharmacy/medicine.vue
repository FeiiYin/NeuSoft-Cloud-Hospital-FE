    ...
    <el-container>
      <el-header>
        <el-row>
          ...
          <el-col :span="5">                
            <el-input
              placeholder="请输入" suffix-icon="el-icon-search" v-model="medicineName"  >
            </el-input>
          </el-col>
          <el-col :span="2" style="padding:10px;">
          ...
          <el-col :span="5">                
            <el-input
              placeholder="请输入" suffix-icon="el-icon-search" v-model="medicineFactory"  >
            </el-input>
          </el-col>
          <el-col :span="2" style="padding:10px;">
          ...
          <el-col :span="5">                
            <el-input
              placeholder="请输入" suffix-icon="el-icon-search" v-model="medicinePinyin"  >
            </el-input>
          </el-col>
