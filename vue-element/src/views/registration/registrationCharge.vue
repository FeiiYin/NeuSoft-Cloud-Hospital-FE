...
<div class="app-container">
    ...
    <div style="padding:1%" class="bg-purple-light">
        ...
        <el-col :span="6"><div class="grid-content bg-purple-light" >
            ...
            <el-form-item label="身份证号">
                <el-input v-model="form.peopleID" :disabled="true"></el-input>
            </el-form-item>
        </div></el-col>
        <el-col :span="6"><div class="grid-content bg-purple-light">
        ...
        <el-col :span="6"><div class="grid-content bg-purple-light">
            <el-form-item label="年龄">
                <el-input v-model="form.ege" :disabled="true"></el-input>
            </el-form-item>
            <el-form-item label="开单医生">
                <el-input v-model="form.doctor" :disabled="true"></el-input>
            </el-form-item>
        </div></el-col>
        </el-row>            
        </el-form>
    ...
    <aside style="height:60px;">
        <span>总共金额： </span>
        <el-input v-model="total_money" :disabled="true" style="width:20%"></el-input>
          
        <el-button type="info" style="float:right">
            <i class="el-icon-printer" />
            打印发票
        </el-button>
        <el-button type="info" style="float:right;margin-right:20px;"
